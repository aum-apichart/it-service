...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // เตรียมคำสั่ง SQL สำหรับเพิ่มข้อมูล (ไม่รวม latitude, longitude และ status)
    $stmt = $conn->prepare("
        INSERT INTO technicians (first_name, last_name, email, password, phone, address) 
        VALUES (?, ?, ?, ?, ?, ?)
    ");
    ...
    if ($stmt->execute()) {
        $success = 'Technician registration successful! You can now log in.';
    } else {
